            ...
            <TbodyColumnLast>
              <div>
                {(() => {
                    if(ele.quantity==0){
                         if (ele.status == "m") {
                            return <MissingSpanStaus>Missing</MissingSpanStaus>;
                          } else if (ele.status == "u") {
                            return <UrgentSpanStaus>Missing - Urgent</UrgentSpanStaus>;
                          }
                    }
                  if (ele.status == "a") {
                    return <ApprovalSpanStaus>Approved</ApprovalSpanStaus>;
                  } else{
                    return <div></div>;
                  }
                })()}
...
const UrgentSpanStaus = styled.span`
...
const MissingSpanStaus = styled.span`
...
const ApprovalSpanStaus = styled.span`
